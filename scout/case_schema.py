...
def empty_case(slug: str = "") -> dict[str, Any]:
    ...
    return {
        ...
        "new_photos_detected": False,
        "listing_recently_updated": False,
        "activity_summary": [],
...
def case_to_ui(c: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "website_audit": {
            ...
            "website_issues": c.get("website_issues") or [],
            "audit_issues": c.get("audit_issues") or [],
            "mobile_pagespeed_score": (c.get("website_audit") or {}).get("checks", {}).get("mobile_pagespeed_score"),
            "load_time": (c.get("website_audit") or {}).get("load_time"),
            "issues": (c.get("website_audit") or {}).get("issues") or [],
            "checks": (c.get("website_audit") or {}).get("checks") or {},
        },
        ...
        "contact": {
            ...
            "contact_form_url": c.get("contact_form_url"),
            "phone_from_site": c.get("phone_from_site"),
            "facebook": c.get("facebook") or c.get("facebook_url"),
            "instagram": c.get("instagram") or c.get("instagram_url"),
            "linkedin": c.get("linkedin"),
        },
        "hours": c.get("hours"),
        "rating": c.get("rating"),
        "review_count": c.get("review_count"),
        "google_review_count": c.get("google_review_count") if c.get("google_review_count") is not None else c.get("review_count"),
        "reviews_last_30_days": c.get("reviews_last_30_days") or 0,
        "owner_post_detected": bool(c.get("owner_post_detected")),
        "new_photos_detected": bool(c.get("new_photos_detected")),
        "listing_recently_updated": bool(c.get("listing_recently_updated")),
        "activity_summary": c.get("activity_summary") or [],
        ...
        "facebook_url": c.get("facebook_url") or c.get("facebook"),
        "instagram_url": c.get("instagram_url") or c.get("instagram"),
        ...
        "lead_bucket": c.get("lead_bucket"),
        "close_probability": c.get("close_probability"),
        "lead_type": c.get("lead_type"),
        "best_contact_method": c.get("best_contact_method"),
        "best_pitch_angle": c.get("best_pitch_angle"),
        ...
        "contact_page_screenshot_url": c.get("contact_page_screenshot_url"),
